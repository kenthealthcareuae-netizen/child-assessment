...
Timestamp: ${new Date().toLocaleString('en-US', { timeZone: 'Asia/Dubai' })}`,
  ...
  return (
    <div className="space-y-4 p-6 bg-card rounded-lg shadow-xl border border-primary/10">
      ...
      <h3 className="text-2xl font-semibold text-primary" dir="ltr">Quick Assessment Booking</h3>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <Label htmlFor="message" className="block text-sm mb-1" dir="ltr">Additional Message</Label>
          <ShadcnTextarea id="message" value={formData.message} onChange={handleChange} placeholder="Child's age, concerns, or specific needs?" dir="ltr" rows={3} disabled={isSubmitting}/>
        </div>
        <Button
          type="submit"
          size="lg"
        ...
        >
          {isSubmitting ? 'Sending...' : 'Book Assessment'}
        </Button>
      </form>
    </div>
  )
                ...
                {showForm ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center lg:justify-start mb-10" dir="ltr">
                      ...
                      >
                        <ArrowRight className="mr-3 h-5 w-5"/> Book Free Assessment
                      </Button>
                    ...
                    <Button size="md" variant="ghost" className="text-primary hover:text-accent underline font-bold uppercase tracking-wide mt-4" asChild>
                      <a href="#services" dir="ltr">Explore Assessment Services →</a>
                    </Button>
                  </motion.div>
                )}
              </AnimatePresence>
